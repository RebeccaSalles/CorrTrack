...
SYNTH_PARAMS = {
    ...
    "max_lag": 7 * 24,  # keep aligned with evaluation N_LAGS / CLI overrides
    "num_templates": "auto",  # one never-reused template per placement -- see docs/implementation_log.md's 2026-08-24 (c) entry
    "threshold": 0.7,
    "corr_sign": "both",
