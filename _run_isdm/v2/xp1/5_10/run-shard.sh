...
#SBATCH --mem=32G
#SBATCH --output=/home/langeb/OAR/out/OAR-v2_5_10_shard_%j.out
#SBATCH --error=/home/langeb/OAR/out/OAR-v2_5_10_shard_%j.out
...
PYTHONPATH=/storage/simple/projects/iroko-lirmm/CorrTrack python3 -m v2.pipeline /storage/simple/projects/iroko-lirmm/CorrTrack/_run_isdm/v2/xp1/5_10/pipeline-run-shard.json
